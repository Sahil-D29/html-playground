  ...
  return (
    <div className="flex h-[calc(100vh-3.5rem)] flex-col bg-gray-50 dark:bg-surface">
      ...
      <div className="flex flex-1 min-h-0 flex-col md:flex-row">
        {/* Code panel */}
        <div className="flex min-w-0 flex-col border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-800/60 md:w-1/2 h-1/2 md:h-full">
        ...
        {/* Preview panel */}
        <div className="flex min-w-0 flex-col md:w-1/2 h-1/2 md:h-full">
