  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] bg-gray-50 dark:bg-surface">
      <div className="mx-auto max-w-5xl px-4 py-8 animate-fade-in">
        ...
        <div className="mb-6 flex gap-1 rounded-xl bg-gray-50 dark:bg-surface-light/50 p-1 border border-gray-200 dark:border-gray-800/40">
          <button
          ...
          >
            Projects
            <span className="ml-2 badge bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400">{projects.length}</span>
          </button>
          <button
            ...
            {projects.length === 0 ? (
              <div className="card-glass p-12 text-center animate-slide-up">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-100 dark:bg-emerald-500/10">
                  <svg className="h-7 w-7 text-emerald-600 dark:text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <>
            {snippets.length === 0 ? (
              <div className="card-glass p-12 text-center animate-slide-up">
                ...
                <h3 className="text-base font-medium text-gray-900 dark:text-white mb-1">No snippets yet</h3>
                <p className="text-sm text-gray-500 mb-5">
