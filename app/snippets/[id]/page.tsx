...
export default async function SnippetPage({
  ...
  return (
    <div className="flex h-[calc(100vh-3.5rem)] flex-col bg-gray-50 dark:bg-surface">
      <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800/60 bg-white/80 dark:bg-surface-light/80 backdrop-blur-sm px-4 py-2">
        <span className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
          ...
          {snippet.title && (
            <>
              ...
              <span className="text-gray-700 dark:text-gray-200 font-medium">{snippet.title}</span>
            </>
          )}
        </span>
