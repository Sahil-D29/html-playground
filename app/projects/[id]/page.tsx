  ...
  return (
    <div className="flex h-[calc(100vh-3.5rem)] bg-gray-50 dark:bg-surface">
      <aside className="flex w-64 flex-col border-r border-gray-200 dark:border-gray-800/60 bg-gray-50 dark:bg-surface-light/30">
          ...
          {renaming ? (
            <div className="flex flex-1 gap-1">
              <input
                ...
                autoFocus
              />
              <button onClick={handleRename} className="btn-icon text-emerald-600 dark:text-emerald-400">
            ...
            <>
              ...
              <h2 className="flex-1 truncate text-sm font-medium text-gray-900 dark:text-white">
                {project.name}
              </h2>
              <button
                onClick={() => {
                ...
                className="btn-icon text-gray-500 hover:text-gray-600 dark:hover:text-gray-300"
              >
                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin p-2">
          ...
          {project.files.length === 0 ? (
            <p className="px-1 text-xs text-gray-400 dark:text-gray-600">No files yet.</p>
          ) : (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {deleting === file.id ? (
                        ...
                        <button
                          ...
                          className="opacity-0 group-hover:opacity-100 text-gray-500 hover:text-red-600 dark:hover:text-red-400 transition-all"
                        >
                          <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800/60 p-2">
      ...
      <main className="flex flex-1 flex-col">
        {activeFile ? (
          <>
            <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800/60 bg-gray-50 dark:bg-surface-light/50 px-3 py-1.5">
          ...
          <div className="flex flex-1 items-center justify-center">
            <div className="text-center">
              <svg className="mx-auto h-10 w-10 text-gray-400 dark:text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
              </svg>
